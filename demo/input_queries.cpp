#include "demo/input_queries.hpp"
...
float get_1d_analog_delta(int, int) {
    return 0.0f;
}
...
glm::vec2 get_2d_analog_delta(int, int) {
    return glm::vec2(0.0f);
}

glm::vec2 get_mouse_pos(int) { return glm::vec2(0.0f); }
glm::vec2 get_mouse_delta(int) { return glm::vec2(0.0f); }
glm::vec2 get_mouse_pos_window(int) { return glm::vec2(0.0f); }
glm::vec2 get_mouse_pos_screen(int) { return glm::vec2(0.0f); }
int get_mouse_wheel_delta(int) { return 0; }
